...
class _AddCustomDrinkState extends State<AddCustomDrink> {
  ...
  void saveDrink() {
    ...
    customDrink.totalkcal =
        customDrink.drinkKCalPerCup / (1 / customDrink.totalCups);
    customDrink.userCupSelected = int.parse(cup.text);
    customDrink.userBasedCalories = (customDrink.totalkcal).toInt();
    DrinkController().addAllDrinks(
        customDrink.drinkId, customDrink.drinkName, customDrink.totalkcal);
