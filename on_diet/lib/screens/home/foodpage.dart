...
import 'package:on_diet/screens/select_food/select_food.dart';
...
class _FoodPageState extends State<FoodPage> {
  ...
  void calculateTotalCaloriesBurnedAndHours() {
    ...
    for (int i = 0; i < selectedDateFoods.length; i++) {
      totalDishesOfFood =
          (selectedDateFoods[i].userDishSelected) + totalDishesOfFood;
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: ListTile(
                    onTap: () async {
                      await Get.to(SelectFood(
                          selectedDateText: selectedHeading,
                          selectedDate: userSelectedDate,
                          selectedDayFoodList: selectedDateFoods));
                      setState(() {
                        calculateTotalCaloriesBurnedAndHours();
                      });
                    },
                ...
                Container(
                  child: ExpansionTileCard(
                    ...
                    trailing: (selectedDateFoods.isEmpty)
                        ? Container(
                            width: 0,
                          )
