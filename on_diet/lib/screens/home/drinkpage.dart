...
import 'package:on_diet/screens/select_drink/select_drink.dart';
...
class _DrinkPageState extends State<DrinkPage> {
  ...
  void calculateTotalCaloriesBurnedAndHours() {
    ...
    for (int i = 0; i < selectedDateDrinks.length; i++) {
      totalCupsOfDrink =
          (selectedDateDrinks[i].userCupSelected) + totalCupsOfDrink;
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: ListTile(
                    onTap: () async {
                      await Get.to(SelectDrink(
                          selectedDateText: selectedHeading,
                          selectedDate: userSelectedDate,
                          selectedDayDrinkList: selectedDateDrinks));
                      setState(() {
                        calculateTotalCaloriesBurnedAndHours();
                      });
                    },
                ...
                Container(
                  child: ExpansionTileCard(
                    ...
                    trailing: (selectedDateDrinks.isEmpty)
                        ? Container(
                            width: 0,
                          )
